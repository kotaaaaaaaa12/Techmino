return {
    ...
    WidgetText={
        ...
        account={
            title="Cuenta",
            displayName="Nombre visible",save="Guardar",manageSignIn="Gestionar acceso",
            loading="Cargando cuenta...",loadNameFailed="No se pudo cargar el nombre visible.",
            notSignedIn="Sesión no iniciada",statusUnavailable="Estado de la cuenta no disponible",guestAccount="Cuenta de invitado",signedInAs="Sesión iniciada como %s",
            enterName="Introduce un nombre visible.",saving="Guardando...",saved="Nombre visible guardado.",savedAs="Guardado como %s",saveFailed="No se pudo guardar el nombre visible.",
            choosePlay="Elige cómo jugar",intro="Inicia sesión para usar la misma cuenta en varios dispositivos o continúa como invitado.",
            guestDescription="Estás jugando como invitado.",signInPrompt="Inicia sesión para usar la misma cuenta en varios dispositivos.",close="Cerrar",
            emailAddress="Correo electrónico",passwordHint="Contraseña (mínimo 8 caracteres)",signIn="Iniciar sesión",createAccount="Crear cuenta",
            continueGoogle="Continuar con Google",refreshGuest="Actualizar cuenta de invitado",continueGuest="Continuar como invitado",signOut="Cerrar sesión",
            invalidCredentials="Introduce un correo válido y una contraseña de al menos 8 caracteres.",signingIn="Iniciando sesión...",creatingAccount="Creando cuenta...",
