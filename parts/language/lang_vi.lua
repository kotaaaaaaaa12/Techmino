...
C. Tay cầm chơi game (Gamepad):
    ...
    WidgetText={
        ...
        account={
            title="Tài khoản",
            displayName="Tên hiển thị",save="Lưu",manageSignIn="Quản lý đăng nhập",
            loading="Đang tải tài khoản...",loadNameFailed="Không thể tải tên hiển thị.",
            notSignedIn="Chưa đăng nhập",statusUnavailable="Không thể lấy trạng thái tài khoản",guestAccount="Tài khoản khách",signedInAs="Đã đăng nhập với tên %s",
            enterName="Hãy nhập tên hiển thị.",saving="Đang lưu...",saved="Đã lưu tên hiển thị.",savedAs="Đã lưu với tên %s",saveFailed="Không thể lưu tên hiển thị.",
            choosePlay="Chọn cách chơi",intro="Đăng nhập để dùng cùng một tài khoản trên nhiều thiết bị, hoặc tiếp tục với tư cách khách.",
            guestDescription="Bạn đang chơi với tư cách khách.",signInPrompt="Đăng nhập để dùng cùng một tài khoản trên nhiều thiết bị.",close="Đóng",
            emailAddress="Địa chỉ email",passwordHint="Mật khẩu (ít nhất 8 ký tự)",signIn="Đăng nhập",createAccount="Tạo tài khoản",
            continueGoogle="Tiếp tục với Google",refreshGuest="Làm mới tài khoản khách",continueGuest="Tiếp tục với tư cách khách",signOut="Đăng xuất",
            invalidCredentials="Nhập email hợp lệ và mật khẩu có ít nhất 8 ký tự.",signingIn="Đang đăng nhập...",creatingAccount="Đang tạo tài khoản...",
