return {
    ...
    WidgetText={
        ...
        account={
            title="Compte",
            displayName="Nom affiché",save="Enregistrer",manageSignIn="Gérer la connexion",
            loading="Chargement du compte...",loadNameFailed="Impossible de charger le nom affiché.",
            notSignedIn="Non connecté",statusUnavailable="État du compte indisponible",guestAccount="Compte invité",signedInAs="Connecté en tant que %s",
            enterName="Saisissez un nom affiché.",saving="Enregistrement...",saved="Nom affiché enregistré.",savedAs="Enregistré sous %s",saveFailed="Impossible d'enregistrer le nom affiché.",
            choosePlay="Choisissez comment jouer",intro="Connectez-vous pour utiliser le même compte sur plusieurs appareils, ou continuez en invité.",
            guestDescription="Vous jouez en tant qu'invité.",signInPrompt="Connectez-vous pour utiliser le même compte sur plusieurs appareils.",close="Fermer",
            emailAddress="Adresse e-mail",passwordHint="Mot de passe (8 caractères minimum)",signIn="Se connecter",createAccount="Créer un compte",
            continueGoogle="Continuer avec Google",refreshGuest="Actualiser le compte invité",continueGuest="Continuer en invité",signOut="Se déconnecter",
            invalidCredentials="Saisissez une adresse e-mail valide et un mot de passe d'au moins 8 caractères.",signingIn="Connexion...",creatingAccount="Création du compte...",
