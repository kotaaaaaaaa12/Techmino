...
手柄：
    ...
    WidgetText={
        ...
        account={
            title="帐户",
            displayName="显示名称",save="保存",manageSignIn="管理登录",
            loading="正在加载帐户...",loadNameFailed="无法加载显示名称。",
            notSignedIn="未登录",statusUnavailable="无法获取帐户状态",guestAccount="访客帐户",signedInAs="已以 %s 登录",
            enterName="请输入显示名称。",saving="正在保存...",saved="显示名称已保存。",savedAs="已保存为 %s",saveFailed="无法保存显示名称。",
            choosePlay="选择游玩方式",intro="登录后可在不同设备上使用同一帐户，也可以访客身份继续。",
            guestDescription="你正在以访客身份游玩。",signInPrompt="登录后可在不同设备上使用同一帐户。",close="关闭",
            emailAddress="电子邮箱",passwordHint="密码（至少8个字符）",signIn="登录",createAccount="创建帐户",
            continueGoogle="使用 Google 继续",refreshGuest="刷新访客帐户",continueGuest="以访客身份继续",signOut="退出登录",
            invalidCredentials="请输入有效的电子邮箱和至少8个字符的密码。",signingIn="正在登录...",creatingAccount="正在创建帐户...",
