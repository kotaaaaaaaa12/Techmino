...
C. Gamepad
    ...
    WidgetText={
        ...
        account={
            title="Account",
            displayName="Display name",save="Save",manageSignIn="Manage sign-in",
            loading="Loading account...",loadNameFailed="Could not load the display name.",
            notSignedIn="Not signed in",statusUnavailable="Account status unavailable",guestAccount="Guest account",signedInAs="Signed in as %s",
            enterName="Enter a display name.",saving="Saving...",saved="Display name saved.",savedAs="Saved as %s",saveFailed="Could not save the display name.",
            choosePlay="Choose how to play",intro="Sign in to keep the same account across devices, or continue as a guest.",
            guestDescription="You are playing as a guest.",signInPrompt="Sign in to keep the same account across devices.",close="Close",
            emailAddress="Email address",passwordHint="Password (8 characters minimum)",signIn="Sign in",createAccount="Create account",
            continueGoogle="Continue with Google",refreshGuest="Refresh guest account",continueGuest="Continue as guest",signOut="Sign out",
            invalidCredentials="Enter a valid email address and a password with at least 8 characters.",signingIn="Signing in...",creatingAccount="Creating account...",
