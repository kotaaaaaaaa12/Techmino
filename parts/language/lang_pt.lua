...
return {
    ...
    WidgetText={
        ...
        account={
            title="Conta",
            displayName="Nome de exibição",save="Salvar",manageSignIn="Gerenciar login",
            loading="Carregando conta...",loadNameFailed="Não foi possível carregar o nome de exibição.",
            notSignedIn="Não conectado",statusUnavailable="Status da conta indisponível",guestAccount="Conta de convidado",signedInAs="Conectado como %s",
            enterName="Digite um nome de exibição.",saving="Salvando...",saved="Nome de exibição salvo.",savedAs="Salvo como %s",saveFailed="Não foi possível salvar o nome de exibição.",
            choosePlay="Escolha como jogar",intro="Entre para usar a mesma conta em vários dispositivos ou continue como convidado.",
            guestDescription="Você está jogando como convidado.",signInPrompt="Entre para usar a mesma conta em vários dispositivos.",close="Fechar",
            emailAddress="Endereço de e-mail",passwordHint="Senha (mínimo de 8 caracteres)",signIn="Entrar",createAccount="Criar conta",
            continueGoogle="Continuar com Google",refreshGuest="Atualizar conta de convidado",continueGuest="Continuar como convidado",signOut="Sair",
            invalidCredentials="Digite um e-mail válido e uma senha com pelo menos 8 caracteres.",signingIn="Entrando...",creatingAccount="Criando conta...",
