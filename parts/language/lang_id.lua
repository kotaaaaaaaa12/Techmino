...
return {
    ...
    WidgetText={
        ...
        account={
            title="Akun",
            displayName="Nama tampilan",save="Simpan",manageSignIn="Kelola login",
            loading="Memuat akun...",loadNameFailed="Nama tampilan tidak dapat dimuat.",
            notSignedIn="Belum login",statusUnavailable="Status akun tidak tersedia",guestAccount="Akun tamu",signedInAs="Login sebagai %s",
            enterName="Masukkan nama tampilan.",saving="Menyimpan...",saved="Nama tampilan disimpan.",savedAs="Disimpan sebagai %s",saveFailed="Nama tampilan tidak dapat disimpan.",
            choosePlay="Pilih cara bermain",intro="Login untuk memakai akun yang sama di beberapa perangkat, atau lanjutkan sebagai tamu.",
            guestDescription="Kamu bermain sebagai tamu.",signInPrompt="Login untuk memakai akun yang sama di beberapa perangkat.",close="Tutup",
            emailAddress="Alamat email",passwordHint="Kata sandi (minimal 8 karakter)",signIn="Login",createAccount="Buat akun",
            continueGoogle="Lanjutkan dengan Google",refreshGuest="Perbarui akun tamu",continueGuest="Lanjutkan sebagai tamu",signOut="Logout",
            invalidCredentials="Masukkan email yang valid dan kata sandi minimal 8 karakter.",signingIn="Sedang login...",creatingAccount="Membuat akun...",
